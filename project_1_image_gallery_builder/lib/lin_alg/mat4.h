...
namespace lin_alg
{
    ...
    struct mat<4, T>
    {
        ...
        /**
         * @brief Construct a mat4 Identity Matrix
         *
         */
        mat<4, T>()
        {
        ...
        /**
         * @brief Construct a mat4 Identity Matrix scaled by scalar value
         *
         * @param scalar
         */
        mat<4, T>(T scalar)
        ...
        /**
         * @brief Construct a new mat4 object with the corresponding values
         * 
         */
        ...
        /**
         * @brief Construct a new mat4 object from mat3 
         * @note simply extends mat3 by filling 0 at empty position and 1 at [3][3]
         * 
         * @param other 
         */
    ...
    /**
     * @brief 4x4 float matrix stored in row-major form
     *
     *
     */
